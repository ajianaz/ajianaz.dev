...
class App {
  ...
  static String DescriptionLong =
      '''I am a Flutter application developer with over four years of experience in software development. My expertise includes developing various types of applications such as GIS (Geographic Information System) applications, attendance tracking, reporting, and applications related to the preparation of infusion for toddlers. My main programming language is Dart and I am familiar with a wide range of Flutter libraries and tools.

      My portfolio includes a GIS-based mobile application for tracking field officers' activities and presenting the data in a map-based interface. I also developed an attendance tracking application that integrates with biometric devices and provides real-time reporting of employee attendance. Another project I worked on was a mobile application that allows healthcare providers to prepare infusion formulas for babies accurately and efficiently.
